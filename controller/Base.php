...
class Base extends Controller
{
	...
	public function initialize()
	{
		...
		// 无需登录的方法
		$except = ['Machine/calculate','Machine/clear_money','Index/index', 'Account/signin', 'Account/signup', 'Account/check', 'Account/forgot','Account/agreement', 'Service/exchange','Handle/sendSms', 'Service/sms', 'Service/sms_check', 'Service/captcha', 'Oauth/qq_login', 'Oauth/qq_callback'];
		// 当前路由
